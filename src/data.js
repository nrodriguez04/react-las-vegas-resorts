...
export default [
  ...
  },
  {
    ...
    fields: {
      ...
      featured: true,
      description:
        "Our Deluxe Rooms have all the amenities to make for a glamorous Las Vegas stay. Not only does this room give you access to Resort Club Lounge, ARIA’s new luxury experience that combines intimacy with elegance – but  also an in-room tablet to have access to reservations, in-room dining and room control all within a touch of your finger.",
      extras: [
        "Plush pillows and breathable bed linens",
        "Soft, oversized bath towels",
        "Full-sized, pH-balanced toiletries",
  ...
  },
  {
    ...
    fields: {
      ...
      featured: true,
      description:
        "We've left nothing to chance in creating our Penthouse Suites. Within this 1,465 square-foot sanctuary you'll find lavish décor and amenities, pulse-quickening, one-of-a-kind views through floor-to-ceiling windows, and our exclusive one-touch in-room technology that allows you to easily customize your suite's features. Our Sky Suites One Bedroom Penthouse wraps you in a luxuriousness you'll be reluctant to leave.",
      extras: [
        "Plush pillows and breathable bed linens",
        "Soft, oversized bath towels",
        "Full-sized, pH-balanced toiletries",
